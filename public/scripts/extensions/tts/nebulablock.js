...
class nebulaBlockTtsProvider {
    ...
    get settingsHtml() {
        ...
        <div class="flex-container flexGap10 wrap">
            <div class="flex1">
                <label for="nebulablock_tts_model">Model</label>
                <select id="nebulablock_tts_model" class="text_pole"></select>
            </div>
            <div>
                <label for="nebulablock_tts_speed">Speed <span id="nebulablock_tts_speed_output"></span></label>
                <input type="range" id="nebulablock_tts_speed" value="1" min="0.25" max="4" step="0.05">
            </div>
            <div>
                <label for="nebulablock_tts_temperature">Temperature</label>
                <input id="nebulablock_tts_temperature" class="text_pole" type="number" min="0" max="2" step="0.1" value="1" />
            </div>
            <div id="nebulablock_block_top_p" style="display:none;">
                <label for="nebulablock_tts_top_p">Top-p</label>
                <input id="nebulablock_tts_top_p" class="text_pole" type="number" min="0" max="1" step="0.01" value="1" />
            </div>
        </div>

        <div id="nebulablock_block_instructions" style="display:none;">
            <label for="nebulablock_tts_instructions">Instructions (GPT-4o Mini TTS):</label>
            <textarea id="nebulablock_tts_instructions" class="textarea_compact autoSetHeight" placeholder="e.g., 'Speak cheerfully and energetically'"></textarea>
        </div>

        <div id="nebulablock_block_dia" style="display:none;">
            <label for="nebulablock_tts_speaker_transcript">Speaker transcript (Dia):</label>
            <textarea id="nebulablock_tts_speaker_transcript" class="textarea_compact autoSetHeight" maxlength="1000"></textarea>
            <label for="nebulablock_tts_cfg_scale">CFG scale (1-5):</label>
            <input id="nebulablock_tts_cfg_scale" type="number" min="1" max="5" step="1" />
            <label for="nebulablock_tts_cfg_topk">CFG filter top_k (15-50):</label>
            <input id="nebulablock_tts_cfg_topk" type="number" min="15" max="50" step="1" />
        </div>

        <div id="nebulablock_block_msft" style="display:none;">
            <div class="flex-container flexGap10 wrap">
                <div>
                    <label for="nebulablock_tts_speech_rate">Speech rate (-100..100)</label>
                    <input id="nebulablock_tts_speech_rate" class="text_pole" type="number" min="-100" max="100" step="1" style="width:120px;" />
                </div>
                <div>
                    <label for="nebulablock_tts_pitch_adjustment">Pitch adjustment (-100..100)</label>
                    <input id="nebulablock_tts_pitch_adjustment" class="text_pole" type="number" min="-100" max="100" step="1" style="width:120px;" />
                </div>
            </div>
            <div class="flex-container flexGap10">
                <div class="flex1">
                    <label for="nebulablock_tts_emotional_style">Emotional style</label>
                    <input id="nebulablock_tts_emotional_style" class="text_pole" type="text" placeholder="cheerful, sad, angry, gentle..." />
                </div>
            </div>
        </div>
